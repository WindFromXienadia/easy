...
function UIController (app) {
    ...
    _this.setShapeStroke = function (shape, layer) {
        ...
        if ("outside" === strokStyle) {
            ...
            shape.paintWidth = layer.shape.cx * 2;
            shape.paintHeight = layer.shape.cy * 2;
    ...
    _this.drawEllipse = function (context, ellipse) {
        ...
        // context.beginPath();
        // context.moveTo(ellipse.leftTopX, ellipse.leftTopY);
        // context.lineTo(ellipse.rightTopX, ellipse.rightTopY);
        // context.lineTo(ellipse.rightBottomX, ellipse.rightBottomY);
        // context.lineTo(ellipse.leftBottomX, ellipse.leftBottomY);
        // context.lineTo(ellipse.leftTopX, ellipse.leftTopY);

        // context.moveTo(Math.min(ellipse.leftTopX, ellipse.leftBottomX, ellipse.rightTopX, ellipse.rightBottomX), Math.min(ellipse.leftTopY, ellipse.leftBottomY, ellipse.rightTopY, ellipse.rightBottomY));
        // context.lineTo(Math.max(ellipse.leftTopX, ellipse.leftBottomX, ellipse.rightTopX, ellipse.rightBottomX), Math.min(ellipse.leftTopY, ellipse.leftBottomY, ellipse.rightTopY, ellipse.rightBottomY));
        // context.lineTo(Math.max(ellipse.leftTopX, ellipse.leftBottomX, ellipse.rightTopX, ellipse.rightBottomX), Math.max(ellipse.leftTopY, ellipse.leftBottomY, ellipse.rightTopY, ellipse.rightBottomY));
        // context.lineTo(Math.min(ellipse.leftTopX, ellipse.leftBottomX, ellipse.rightTopX, ellipse.rightBottomX), Math.max(ellipse.leftTopY, ellipse.leftBottomY, ellipse.rightTopY, ellipse.rightBottomY));
        // context.lineTo(Math.min(ellipse.leftTopX, ellipse.leftBottomX, ellipse.rightTopX, ellipse.rightBottomX), Math.min(ellipse.leftTopY, ellipse.leftBottomY, ellipse.rightTopY, ellipse.rightBottomY));
